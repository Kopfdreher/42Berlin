...
Fixed::Fixed(float const value) { _value = roundf(value * (1 << _fractBits)); }
...
float Fixed::toFloat() const { return (float)_value / (1 << _fractBits); }

int Fixed::toInt() const { return _value >> _fractBits; }
